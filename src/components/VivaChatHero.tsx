...
export default function VivaChatHero() {
  return (
    <section className="w-full min-h-screen bg-black mt-10 py-16 px-6">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-start mb-16">
          ...
          <div className="space-y-6">
            <div className="flex items-center gap-4 mb-6">
              <h1 className="text-xl md:text-5xl lg:text-6xl font-bold text-white leading-tight">
                Connect Instantly, Communicate Effortlessly - Mitcko!
              </h1>
          ...
          <div className="space-y-6 lg:pt-12">
            <p className="text-gray-200 text-lg leading-relaxed">
              Seamlessly bridge distances, spark dialogues, and elevate your
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          ...
          <div className="space-y-4">
            <div className="relative h-48 rounded-3xl overflow-hidden bg-gradient-to-r from-sky-500 to-blue-600 shadow-lg hover:shadow-xl transition-shadow duration-300 flex items-center justify-center p-6">
              <div className="text-center">
                ...
                <p className="text-sm font-medium text-gray-100">experience</p>
              </div>
            </div>
